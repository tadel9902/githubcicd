    ...
    <div class="favorite_book_list flex_center mg-10_0">
        <div class="_1200px bg-white flex_col pd-10">
            ...
            <div class="favorite_book_list_icon_title " style="padding: 5px 0px; border-bottom: 1px solid #007bff;">
                    ...
                    <span class="favorite_book_list_title mg-l-10">Sách viết bởi NXB: ${company_name}</span>
            </div>

            <div class="favorite_book_item flex_center mg-10_0">
                
                <c:forEach var = "item" items = "${book_company}">
                    ...
                    <span class="info"></span>
                        ...
                        <form class = "add_to_cart" action="<c:url value = '/company/add/${id_company}.htm' />" method="post">
            ...
            <nav aria-label="Page navigation">
             ...
             <form action="<c:url value = '/company/${id_company}.htm' />" id = "form_page">
