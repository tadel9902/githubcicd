        ...
        <div class="_1200px flex_center signup_container">
            <div class="signup_container_left">
                ...
                <form action="" method="post" class="form_signup">
                    ...
                    <div class="check_remember" style = "display:flex; align-items:center; margin-top: 7px; color: red">
                        ${login_status}
                    </div>
                ...
                <div class="login_signin">Bạn chưa có tài khoản <a href="signup.htm">Đăng ký</a></div>
