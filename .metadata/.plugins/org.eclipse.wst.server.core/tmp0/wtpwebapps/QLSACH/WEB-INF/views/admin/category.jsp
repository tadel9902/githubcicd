  ...
  <body>
    <div id="app doan">
      <div class="background_black" id="background_black">
        ...
        <form action = "<c:url value = '/admin/category/delete.htm' />" method="post" class="confirm_container remove_class bg-white">
                      ...
                      <div class="card-body">
                        ...
                        >
                          ...
                          <div style="display: flex;">
                              ...
                              <div class="form_add display_none" style="margin-left: 20px;">
                                  <form action="<c:url value = '/admin/category/add.htm' />" method="post" style="display: flex;">
                                    <input class="form-control" name="nameCategory" type="text" value="" id="input_add" placeholder="VD: Truyện Thiếu Nhi">
                        ...
                        <div class="table-responsive pt-3">
                          <table class="table table-bordered text-center">
                            <thead>
                              <tr>
                                <th><a href="<c:url value = '/admin/category.htm?page=${currentpage}&order=id&dir=${orderLink}' />">ID</a></th>
                                <th style="width: 65%;"><a href="<c:url value = '/admin/category.htm?page=${currentpage}&order=name&dir=${orderLink}' />">Tên thể loại</a></th>
                                <th>Thay Đổi</th>
                              </tr>
                            </thead>
                            <tbody id = "table_data">
                            <c:forEach var = "item" items = "${categories}">
                                ...
                                <td>
                                  <span class="ten_hien_thi">${item.category_name}</span>
                                  <div class="form_chinh_sua display_none">
                                    <form action="<c:url value = '/admin/category/edit.htm' />" method="post" style="display: flex;">
                                      <input type="hidden" name="idCategory" value="${item.category_id}">
                                      <input class="form-control class_input_edit" name="nameCategory" type="text" value="${item.category_name}"/>
    ...
    <script type="text/javascript" src="<c:url value = '/include/js/admin/category_admin.js' />"></script>
  </body>
</html>
