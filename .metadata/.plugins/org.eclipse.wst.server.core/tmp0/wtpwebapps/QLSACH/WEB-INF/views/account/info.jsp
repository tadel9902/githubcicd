                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="col-12" style="display: flex; justify-content: center;">
                          <div class="col-6">
                              <form action="<c:url value ='/account/info.htm' />" method="post" id = "form_edit_info_submit">
                                <div style="margin-bottom: 20px">
                                  <label class="form-label">Tên Đăng Nhập</label>
                                  <input class="form-control showordisable" name="username" disabled value = "${user.username}" type="text" placeholder="Nhập tên tài khoản">
                                </div>
                                <div style="margin-bottom: 20px">
                                  <label class="form-label">Địa chỉ Email</label>
                                  <input class="form-control showordisable" id = "info_email_input" name = "email" value = "${user.email}" type="email" placeholder="Nhập địa chỉ email">
                                  <p class = "text-danger" style="font-size: 14px;font-weight: bold;display:none;">Địa chỉ Email không hợp lệ</p>
                                </div>

                                <div style="margin-bottom: 20px">
                                  <label class="form-label">Số điện thoại</label>
                                  <input class="form-control showordisable" id = "info_phone_input" name="phone" value = "${user.phone}" type="number" placeholder="Nhập số điện thoại">
                                  <p class = "text-danger" style="font-size: 14px;font-weight: bold;display:none;">Số điện thoại không hợp lệ</p>
                                </div>

                                <div style="margin-bottom: 20px">
                                  <label class="form-label">Năm Sinh</label>
                                  <input class="form-control showordisable" name="age" value = "${user.age}" type="number" placeholder="Nhập số tuổi bạn hiện tại">
                                </div>
								<div style="margin-bottom: 20px">
                                  <label class="form-label">Địa chỉ</label>
                                  <input class="form-control showordisable" name="address" value = "${user.address}" type="text" placeholder="Nhập địa chỉ hiện tại">
                                </div>
                                <div style="margin-bottom: 20px; display: flex">
                                  <div style="margin:0; margin-right: 20px;" class = "form-label">Giới tính</div>
                                  <div class="form-check" style="margin-right: 20px;">
                                    <input class="form-check-input" type="radio" name="gender" value = "1" <c:if test="${user.gender == 1}">checked</c:if>/>
                                    <label class="form-check-label">Nam</label>
                                  </div>
                                  <div class="form-check">
                                    <input class="form-check-input" type="radio" name="gender" value = "0" <c:if test="${user.gender == 0}">checked</c:if> />
                                ...
                                <div style="margin-bottom: 20px; text-align: center">
                                  ...
                                  <button type="button" id = "btn_edit_info" class="btn btn-success">Cập nhật thông tin</button>
                                </div>
                                </form>
                          </div>
                        </div>
                  ...
                  <div class="col-lg-12 stretch-card" style="padding: 0">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="col-12" style="display: flex; justify-content: center;">
                          <div class="col-6">
                              <form action="<c:url value ='/account/updatepassword.htm' />" method="post">
                                <div style="margin-bottom: 20px">
                                  <label class="form-label">Nhập mật khẩu cũ</label>
                                  <input class="form-control showordisable" name="oldpassword" type="password" placeholder="Nhập mật khẩu cũ">
                                </div>
                                <div style="margin-bottom: 20px">
                                  <label class="form-label">Nhập mật khẩu mới</label>
                                  <input class="form-control showordisable" name = "newpassword" type="password" placeholder="Nhập mật khẩu mới">
                                </div>

                                <div style="margin-bottom: 20px">
                                  <label class="form-label">Nhập lại mật khẩu mới</label>
                                  <input class="form-control showordisable" name="renewpassword" type="password" placeholder="Nhập lại mật khẩu mới">
                                </div>
                                <div style="margin-bottom: 20px; text-align: center">
