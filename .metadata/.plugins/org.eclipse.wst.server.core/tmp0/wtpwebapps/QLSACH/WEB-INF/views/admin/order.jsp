	...
	console.log(arr_book_order)
    	...
    	if(x != ""){
	    	if(x == '0'){ // == 0 sai order_old
	    		// Toast thất bại
		  		createToastHTML("Đã cập nhật đơn hàng này trước đó", "ERROR", "#DC3545", "fas fa-exclamation-triangle");
	    	}else if(x == '-1'){ // == 0 sai order_old
	    		// Toast thất bại
		  		createToastHTML("Lỗi do đã thực hiện sửa đường link trạng thái đơn hàng", "ERROR", "#DC3545", "fas fa-exclamation-triangle");
	    	}else if(x == '1'){
	    		// Toast thành công
		  		createToastHTML("Cập nhật trạng thái đơn hàng thành công", "SUCCESS", "#47f764", "fas fa-check-circle");
	    	}else if(x == '2'){
	    		// Toast thất bại
		  		createToastHTML("Cập nhật trạng thái đơn hàng thất bại", "ERROR", "#DC3545", "fas fa-exclamation-triangle");
	    	}
    	}
